...
class BkashController extends Controller
{
    ...
    public function pay(Request $request,$id)
    {
        ...
        \Illuminate\Support\Facades\Session::put('bkash_amount',$bkashAmount);
        Session::put('membership_id',$id);
        Session::put('payment_amount', $bkashAmount);
        ...
        if (Auth::user()->user_type == 'seller'){
            ...
            return view('frontend.buyer.premium_membership.buy_now_details',compact('membershipPackage','bkashAmount'));
        }
