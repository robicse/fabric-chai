                                        ...
                                        <div class="sign-in-form">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <a href="{{route('seller.product.show')}}">
                                                        <div class="card border-primary mb-3" style="max-width: 18rem; margin: 10px; background-color: #f3f3f3">
                                                            <div class="card-body text-primary card_height">
                                                                <h5 class="text-center" style="color: #e70909"> <i class="fa fa-cart-plus"></i> </h5>
                                                                <div class="text-center">
                                                                    <h5 style="color: #e70909;">SELL</h5> <hr style="color: #e70909;">
                                                                    <h5 style="color: #e70909;">বিক্রি</h5>
                                                ...
                                                <div class="col-lg-6 col-6">
                                                    <!-- small box -->
                                                    {{--                                                    <div class="small-box">--}}
                                                    {{--                                                        <h3><a href="{{route('buyer.product.show')}}" class="small-box-footer">Buy <i class="fas fa-arrow-circle-right"></i></a></h3>--}}
                                                    {{--                                                    </div>--}}
                                                    <a href="{{route('buyer.product.show')}}">
                                                        <div class="card border-success mb-3" style="max-width: 18rem; margin: 10px; background-color: #f3f3f3;">
                                                            <div class="card-body text-success card_height">
                                                                <h5 class="text-center" style="color: green;"> <i class="fa fa-cart-plus"></i> </h5>
                                                                <div class="text-center">
                                                                    <h5 style="color: green;">BUY</h5> <hr style="color: green;">
                                                                    <h5 style="color: green;">ক্রয়</h5>
                                            ...
                                            <div class="row" style="padding-top: 30px;">
                                                    ...
                                                    <a href="{{route('job.registration')}}">
                                                        <div class="card border-secondary mb-3" style="max-width: 18rem; margin: 10px; background-color: #f3f3f3;">
                                                            <div class="card-body text-secondary card_height">
                                                                ...
                                                                <div class="text-center">
                                                                    <h5 style="color: purple;">JOB</h5> <hr style="color: purple;">
                                                                    <h5 style="color: purple;">চাকুরী </h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="col-lg-6 col-6">
                                                    ...
                                                    <a href="{{route('work-order.registration')}}">
                                                        <div class="card border-info mb-3" style="max-width: 18rem; margin: 10px; background-color: #f3f3f3;">
                                                            <div class="card-body text-info card_height">
                                                                <h5 class="text-center" style="color: #16CCF1;"> <i class="fa fa-file-alt"></i> </h5>
                                                                <div class="text-center">
                                                                    <h5 style="color: #16CCF1;">WORK ORDER</h5> <hr style="color: #16CCF1;">
                                                                    <h5 style="color: #16CCF1;">কাজের আদেশ</h5>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
