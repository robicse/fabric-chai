                ...
                <div class="col-12 col-md-6 col-lg-7">
                            ...
                            @else
                                <div>
                                    ...
                                    <span class="stock-availability in-stock text-success font-500">
                                        <strong class="">{{ getNumberToBangla($detailedProduct->quantity) }} {{getNameByBnEn($detailedProduct->unit)}}</strong>
                                   </span>
                                </div>
                    ...
                    <form action="{{route('product-bid.store')}}" method="POST" class="fp_top" >
                        ...
                        <div class="mt-3">
                            <div class="row">
                                <div class="col-3">
                                    <h5>@lang('website.Bid Price') (@lang('website.Unit')) ({{currency()->code}}):</h5>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <h5>@lang('website.Bid Price') (@lang('website.Total')) ({{currency()->code}}):</h5>
                                </div>
                                <div class="col-md-6 col-9">
                                    <div class="form-group d-inline">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <h5>@lang('website.Bid Price') (@lang('website.Unit')) ({{currency()->code == 'BDT' ? 'USD' : 'BDT'}}):</h5>
                                </div>
                                <div class="col-md-6 col-9">
                                    <div class="form-group d-inline">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <h5>@lang('website.Bid Price') (@lang('website.Total')) ({{currency()->code == 'BDT' ? 'USD' : 'BDT'}}):</h5>
                                </div>
                                <div class="col-md-6 col-9">
                                    <div class="form-group d-inline">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group d-inline pb-2 mb-2">
                                        <div>&nbsp;</div>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" onclick="get_bidPrice()" data-bs-target="#staticBackdrop">@lang('website.Bid for Trade')</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div>
                                            <p><span class="text-black ">@lang('website.Name'):</span> {{getNameByBnEn($detailedProduct->user)}}<br>
                                                <span class="text-black ">@lang('website.Total Amount'):</span>{{getNumberWithCurrencyByBnEn($detailedProduct->expected_price)}} <br>
                                                            ...
                                                            <li>
                                                                <div class="comment_container">
                                                                    ...
                                                                    <div class="comment-text">
                                                                        ...
                                                                        <p class="meta">
                                                                            <strong
                                                                                class="woocommerce-review__author">{{getNameByBnEn($review->sender)}} </strong>
                                                                            <span class="woocommerce-review__dash">–</span>
                                                                            <span class="woocommerce-review__published-date">{{getDateConvertByBnEn($review->created_at)}}</span>
                                                                        </p>
