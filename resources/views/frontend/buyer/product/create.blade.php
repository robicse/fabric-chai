    ...
    <div class="full-row m_t_30">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <form class="woocommerce-form-login" action="{{route('buyer.my-request.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card card-info card-outline">
                            ...
                            <div class="card-body">
                                <div class="row m-2">
                                    <div class="col-md-10">
                                        <h4 class="pl-2 pb-0 mb-2 bg-info"><span class="m_l_10" >@lang('website.Product Information') <span class="required">*</span></span></h4>
                                        <div class="row">
                                            <div class="form-group col-md-12 @if($lang !== 'en') d-none @endif">
                                                <label for="name"> @lang('website.Product Type English') <span class="required">*</span></label>
                                                <input type="text" class="form-control " name="name" id="name" placeholder="@lang('website.Enter Product Type English')">
                                            ...
                                            <div class="form-group col-md-12 @if($lang !== 'bn') d-none @endif">
                                                ...
                                                <input type="text" class="form-control " name="name_bn" id="name_bn" placeholder="@lang('website.Enter Product Type Bangla')">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-10 p_t_20" >
                                        ...
                                        <h4 class="pl-2 pb-0 mb-2 bg-info"><span class="m_l_10">@lang('website.Product Image') <span class="required">*</span></span></h4>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <a href="https://tinypng.com/" target="_blank" class="btn btn-primary resize" ><i class="fa fa-edit"></i></a> @lang('website.Resize')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-10 p_t_20" >
                                        ...
                                        <h4 class="pl-2 pb-0 mb-2 bg-info"><span class="m_l_10">@lang('website.Product Price Details') <span class="required">*</span></span></h4>
                                        <div class="form-group">
                                            <label for="quantity">@lang('website.Quantity') <span class="required">*</span></label>
                                            <input type="text" class="form-control price_summation" min="1" name="quantity" id="quantity" value="" placeholder="@lang('website.Quantity must be greater than 0')" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="" step="0.00001" placeholder="0" name="unit_price" id="unit_price" class="form-control price_summation" onkeyup="get_bid_price(this)" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="expected_price">@lang('website.Total Price') <span class="required">*</span></label>
                                                    <input type="number" value="" step="0.00001" name="expected_price" class="form-control bg-gray-light" id="expected_price" required readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control bg-gray-light" name="" id="bid_convert_unit_price" min="0" step="0.00001" placeholder="" readonly required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="expected_price">@lang('website.Total Price')</label>
                                                    <input type="number" class="form-control bg-gray-light" name="" id="bid_convert_total_price" min="0" step="0.00001" placeholder=""  readonly required>
                                                </div>
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label for="price_validity">@lang('website.Price Validate Till')</label>
                                                <input type="date" class="form-control bg-gray-light" name="price_validity" id="price_validity">
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group @if($lang !== 'en') d-none @endif">
                                            <label for="description">@lang('website.Product Description English')<span class="required">*</span></label>
                                        ...
                                        <div class="form-group @if($lang !== 'bn') d-none @endif">
                                            <label for="description_bn">@lang('website.Product Description Bangla')<span class="required">*</span></label>
                        ...
                        <button type="button" class="woocommerce-form-login__submit btn btn-primary rounded-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">@lang('website.Submit')</button>
