...
@section("title","Edit Buyer Requested Products")
@push('css')
...
@section('content')
    ...
    <!-- Main content -->
    <form role="form" id="choice_form" action="{{route('admin.buyer-requested-product.update',$product->id)}}" method="post"
        ...
        <section class="content">
            <div class="row m-2">
                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <div class="form-group ">
                                <label for="name">Product Type (@lang('website.Optional')) </label>
                            ...
                            <div class="form-group mt-2" id="category_five">
                                <select name="sub_sub_child_child_category_id" id="sub_sub_child_child_category_id" class="form-control demo-select2">
                                </select>
                            </div>
                ...
                <div class="col-md-6">
                    <!-- general form elements -->
                    <div class="card card-info card-outline">
                        <p class="pl-2 pb-0 mb-0 bg-info">Product Image (@lang('website.Optional')) </p>
                        <div class="form-group">
                            <label class="control-label ml-3">Gallery Images (@lang('website.Optional')) <span class="required">*</span> <small class="text-danger">(Size: 290 * 300px)</small></label>
                            <div class="ml-3 mr-3">
            ...
            <div class="row m-2">
                <div class="col-md-12">
                    <div class="card card-info card-outline" style="padding: 20px;">
                        <p class="pl-2 pb-0 mb-0 bg-info">Product Price Details (@lang('website.Optional')) </p>
                        <div class="row" style="border-right: 1px solid #ddd;">
                            ...
                            <div class="form-group col-6">
                                <label for="unit_id">Unit (@lang('website.Optional')) </label>
                                <select name="unit_id" id="unit_id" class="form-control demo-select2" required>
                                    <option value="">Select (@lang('website.Optional')) </option>
                        ...
                        <div class="row" style="border-right: 1px solid #ddd;">
                            ...
                            <div class="form-group col-3">
                                <label for="unit_price">Unit price (@lang('website.Optional')) </label>
                            ...
                            <div class="form-group col-3">
                                <label for="expected_price">Total price (@lang('website.Optional')) </label>
                                <input type="number" min="0" value="{{$product->expected_price}}" step="0.00001"
                                       name="expected_price"
                                       class="form-control" id="expected_price" required>
                            </div>
                            <div class="form-group col-3">
                                <label for="expected_price">Featured (@lang('website.Optional')) </label>
                                <div class="row">
                                    <div class="col-4">
                            ...
                            <div class="form-group col-3 d-none">
                                <label for="currency_id">Currency (@lang('website.Optional')) </label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="price_validity">Price Validate Till (@lang('website.Optional')) </label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="made_in">Made In (@lang('website.Optional')) </label>
                        ...
                        <div class="form-group">
                            <label for="description">Product Description (@lang('website.Optional')) </label>
