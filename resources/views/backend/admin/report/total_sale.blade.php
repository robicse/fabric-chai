...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Total Sales/GMV</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Total Sales/GMV</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('admin.total-sales')}}" method="get">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('admin.total-sales')}}" type="reset" class="btn btn-secondary">Cancel</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title float-left">Total Sales/GMV</h3>
                        <div class="float-right">
                            <div>
                                @if(Auth::User()->user_type == 'admin')
{{--                                    <a href="{{URL('admin/total-sale-export/'.$start_date.'/'.$end_date.'/'.$sale_type)}}" target="_blank">--}}
{{--                                        <button class="btn btn-info text-center" style="">Excel</button>--}}
{{--                                    </a>--}}
{{--                                    <a href="{{URL('admin/total-sale-pdf/'.$start_date.'/'.$end_date.'/'.$sale_type)}}" target="_blank">--}}
...
{{--                                    </a>--}}
                    ...
                    <div class="tile-footer text-right">
                        <h3><strong><span style="margin-right: 50px;">Total Sell: {{$totalSales->count()}}</span></strong></h3>
                        <h3><strong><span style="margin-right: 50px;">Total Amount: {{$totalSales->sum('amount')}}</span></strong></h3>
                        <h3><strong><span style="margin-right: 50px;">Total VAT: {{$totalSales->sum('vat')}}</span></strong></h3>
                    </div>
                    <!-- /.card-body -->
                </div>
            </div>
